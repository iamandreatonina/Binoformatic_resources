...
Since the total graph and the subgraph were large graphs with >500 nodes we decided to plot them using the ggnet2 function, part of the GGally package. We also decided to resize and color the nodes based on the additional information on the number of outdegree edges.
```{r}
library(igraph)
library(GGally)
